                        ...
                        <tr style="border-collapse:collapse">
                            <td cellpadding="0" cellspacing="0" border="0"
                                style="padding:0;Margin:0;line-height:1px;min-width:600px" height="0"><img
                                    src="https://uflnyx.stripocdn.email/content/guids/CABINET_837dc1d79e3a5eca5eb1609bfe9fd374/images/41521605538834349.png"
            ...
            <tr style="border-collapse:collapse">
                <td valign="top" style="padding:0;Margin:0">
                    <table class="es-header" cellspacing="0" cellpadding="0" align="center"
                        ...
                        <tr style="border-collapse:collapse">
                            <td align="center" bgcolor="#E5E5E5" style="padding:0;Margin:0;background-color:#e5e5e5">
                                <table class="es-header-body" cellspacing="0" cellpadding="0" align="center"
                                    style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:transparent;width:600px">
                                    <tr style="border-collapse:collapse">
                                        <td align="left" bgcolor="#ffffff"
                                            style="Margin:0;padding-bottom:10px;padding-left:10px;padding-right:10px;padding-top:20px;background-color:#ffffff">
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    ...
                                                                    <img src="https://uflnyx.stripocdn.email/content/guids/CABINET_96c26b86936799aa1e03d813ab415e57/images/frame2.png"
                                                                        alt
                    ...
                    <table class="es-content" cellspacing="0" cellpadding="0" align="center"
                        ...
                        <tr style="border-collapse:collapse">
                            <td style="padding:0;Margin:0;background-color:#e5e5e5" bgcolor="#E5E5E5" align="center">
                                                        ...
                                                        <table
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    ...
                                                                    <img class="adapt-img"
                                                                        src="https://uflnyx.stripocdn.email/content/guids/CABINET_96c26b86936799aa1e03d813ab415e57/images/frame.png"
                                                                        alt
                                                                        style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
                                                                        width="600">
                                                                </td>
                    ...
                    <table class="es-content" cellspacing="0" cellpadding="0" align="center"
                        ...
                        <tr style="border-collapse:collapse">
                            <td align="center" bgcolor="#E5E5E5" style="padding:0;Margin:0;background-color:#e5e5e5">
                                <table class="es-content-body"
                                    style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#e5e5e5;width:600px"
                                    cellspacing="0" cellpadding="0" align="center" bgcolor="#E5E5E5">
                                    <tr style="border-collapse:collapse">
                                        <td align="left" style="padding:0;Margin:0">
                                            <table width="100%" cellspacing="0" cellpadding="0"
                                                style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" bgcolor="#ffffff"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        {{ $arendatario->name }}
                                                                        {{ $arendatario->last_name }} te ha invitado a
                        ...
                        <tr style="border-collapse:collapse">
                            <td align="center" bgcolor="#E5E5E5" style="padding:0;Margin:0;background-color:#e5e5e5">
                                <table class="es-footer-body"
                                    style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#e5e5e5;width:600px"
                                    cellspacing="0" cellpadding="0" bgcolor="#E5E5E5" align="center">
                                    <tr style="border-collapse:collapse">
                                        <td style="padding:20px;Margin:0;background-color:#625d9c" bgcolor="#625D9C"
                                            align="left">
                                                ...
                                                <tr style="border-collapse:collapse">
                                                    <td align="left" style="padding:0;Margin:0;width:270px">
                                                        <table
                                                            ...
                                                            role="presentation">
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" align="right"
                                                                    ...
                                                                    <table class="es-table-not-adapt es-social"
                                                                        ...
                                                                        <tr style="border-collapse:collapse">
                                                                            <td valign="top" align="center"
                                                                                ...
                                                                                <img title="Facebook"
                                                                                    src="https://uflnyx.stripocdn.email/content/assets/img/social-icons/logo-white/facebook-logo-white.png"
                                                                                    alt="Fb" width="32"
                                                                                    style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic">
                                                                            </td>
                                                                            <td valign="top" align="center"
                                                                                style="padding:0;Margin:0;padding-right:10px">
                                                                                <img title="Twitter"
                                                                                    src="https://uflnyx.stripocdn.email/content/assets/img/social-icons/logo-white/twitter-logo-white.png"
                                                                                    alt="Tw" width="32"
                                                                                    style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic">
                                                                            </td>
                                                                            <td valign="top" align="center"
                                                                                style="padding:0;Margin:0"><img
                                                                                    title="Instagram"
                                                                                    src="https://uflnyx.stripocdn.email/content/assets/img/social-icons/logo-white/instagram-logo-white.png"
                                                                                    alt="Inst" width="32"
                                                                                    style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic">
                                                                            </td>
                                                                        </tr>
